import{e as tt}from"./chunk-AW5KTZNU.js";import{C as et,E as M,F as st,G as N,H as V,M as w,a as h,c as l}from"./chunk-3BNHFXWM.js";var vt="sh1an-playlists",ht="sh1an-music-videos-cache-v3",yt="sh1an-song-requests-cache-v1",$t="sh1an-song-requests-local-v1",at=24,y="all-streams",P=1,K="newest",A="grid",v=null,H=null,F=!1,D="",nt=null,L=!1,q=new Set,g=null,Y=!1,k="";function _(){try{return JSON.parse(localStorage.getItem(vt)||"[]")}catch{return[]}}function C(t){try{localStorage.setItem(vt,JSON.stringify(t))}catch{}}function wt(t){let e=_(),s={id:String(Date.now()),name:t.trim(),createdAt:new Date().toISOString(),streams:[]};return e.unshift(s),C(e),s}function Bt(t){C(_().filter(e=>e.id!==t))}function jt(t,e){let s=_(),a=s.find(n=>n.id===t);return!a||a.streams.includes(e)?!1:(a.streams.push(e),C(s),!0)}function Dt(t,e){let s=_(),a=s.find(n=>n.id===t);a&&(a.streams=a.streams.filter(n=>n!==e),C(s))}function U(t){return _().some(e=>e.streams.includes(t))}function T(){let t=h("#panel-playlists");if(!t)return;let e=tt.data?.streams||[];if(y==="my-playlists"&&v===null){let n=G();n.length?v=n:qt().then(r=>{v===null&&(v=Array.isArray(r)?r:[]),y==="my-playlists"&&T()})}let s=document.activeElement?.id==="pl-music-search",a=null;if(s){try{a=document.activeElement.selectionStart}catch{}D=document.activeElement.value||""}if(t.innerHTML=`
    <div class="pl-wrap">
      ...
      <div class="pl-subtab-body" id="pl-subtab-body">
        ${y==="all-streams"?_t(e,P):y==="music"?Ht():y==="my-playlists"?pe(e):At()}
      </div>
    </div>
  `,y==="music"&&Yt(),y==="requests"&&ee(),s){let n=h("#pl-music-search");if(n&&(n.focus(),a!==null))try{n.setSelectionRange(a,a)}catch{}}t.onclick=n=>{let r=n.target.closest("[data-pl-subtab]");if(r){y=r.dataset.plSubtab,y==="all-streams"&&(P=1),T();return}let i=n.target.closest("[data-pl-sort]");if(i){K=i.dataset.plSort,P=1,rt(e);return}let c=n.target.closest("[data-pl-page]");if(c&&!c.disabled){P=Number(c.dataset.plPage),rt(e);return}let u=n.target.closest("[data-music-view]:not([data-music-select-toggle])");if(u){A=u.dataset.musicView,z();return}if(n.target.closest("[data-music-select-toggle]")){L=!L,L||q.clear(),it();return}let d=n.target.closest("[data-mv-select]");if(d){let f=d.dataset.mvSelect,o=!q.has(f);o?q.add(f):q.delete(f);let m=d.classList.contains("mv-list-row")?d:d.closest(".mv-card");m&&m.classList.toggle("is-selected",o);let $=m?.querySelector(".mv-card-checkbox, .mv-list-checkbox");$&&($.innerHTML=o?w("check"):""),d.setAttribute("aria-pressed",String(o)),Ft();return}if(n.target.closest("[data-music-select-all]")){Q(v||[]).forEach(({v:f})=>q.add(f.id)),it();return}if(n.target.closest("[data-music-select-clear]")){q.clear(),it();return}if(n.target.closest("[data-music-select-add]")){if(!q.size)return;let f=[...v||[]].filter(o=>q.has(o.id)).map(o=>"mv:"+o.id);bt(f);return}let b=n.target.closest("[data-playlist-add-mv]");if(b){let f=b.dataset.playlistAddMv,o=b.dataset.streamTitle||"";bt("mv:"+f,o);return}let p=n.target.closest("[data-mv-watch]");if(p&&v?.length){if(n.metaKey||n.ctrlKey||n.shiftKey||n.button===1)return;n.preventDefault();let f=v[Number(p.dataset.mvWatch)];f?.url&&window.__openStreamViewer?.({url:f.url,title:f.title,isMv:!0});return}y==="my-playlists"&&fe(n,e),y==="requests"&&se(n)},t.oninput=n=>{let r=n.target.closest("#pl-music-search");r&&(D=r.value||"",clearTimeout(nt),nt=setTimeout(z,100))},t.oncompositionend=n=>{let r=n.target.closest("#pl-music-search");r&&(D=r.value||"",clearTimeout(nt),z())},t.onchange=n=>{let r=n.target.closest("#pl-stream-sort");r&&(K=r.value,P=1,rt(e))},t.addEventListener("error",n=>{let r=n.target;if(!r.classList.contains("pl-sg-thumb"))return;let i=r.dataset.fallback;i&&r.src!==i&&(r.src=i,delete r.dataset.fallback)},!0),ve()}var Ot=[{key:"newest",label:"\u65B0\u3057\u3044\u9806"},{key:"oldest",label:"\u53E4\u3044\u9806"},{key:"most-songs",label:"\u66F2\u6570\u2193"},{key:"fewest-songs",label:"\u66F2\u6570\u2191"}];function Vt(t,e){let s=t.slice();return e==="oldest"?s.reverse():e==="most-songs"?s.sort((a,n)=>(n.songs?.length??0)-(a.songs?.length??0)):e==="fewest-songs"?s.sort((a,n)=>(a.songs?.length??0)-(n.songs?.length??0)):s}function _t(t,e){if(!t.length)return`
      <div class="pl-empty-state">
        <p>\u914D\u4FE1\u30C7\u30FC\u30BF\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059\u2026</p>
        <p class="pl-empty-hint">\u5148\u306B\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3\u30BF\u30D6\u3092\u958B\u304F\u3068\u3059\u3050\u306B\u8868\u793A\u3055\u308C\u307E\u3059</p>
      </div>`;let s=Vt(t,K),a=s.length,n=Math.max(1,Math.ceil(a/at)),r=Math.min(Math.max(1,e),n),i=(r-1)*at,u=s.slice(i,i+at).map(p=>{let f=M(p),o=N(p.url),m=V(p.url),$=p.songs?.length??0;return`
    ...
    <div class="pl-sort-bar">
      <label class="pl-sort-field">
        ...
        <select class="select-input" id="pl-stream-sort">
          ${Ot.map(p=>`<option value="${p.key}"${K===p.key?" selected":""}>${p.label}</option>`).join("")}
        </select>
      </label>
    </div>`}<div class="pl-stream-grid" id="pl-stream-grid">${u}</div>${d}`}function rt(t){let e=h("#pl-subtab-body");if(!e){T();return}e.innerHTML=_t(t,P);let s=h("#panel-playlists");s&&s.addEventListener("error",a=>{let n=a.target;if(!n.classList.contains("pl-sg-thumb"))return;let r=n.dataset.fallback;r&&n.src!==r&&(n.src=r,delete n.dataset.fallback)},{once:!0,capture:!0}),e.scrollIntoView({behavior:"smooth",block:"start"})}function Ht(){if(v===null){let t=G();t.length&&(v=t)}return ut(v||[])}async function Yt(){if(v!==null){lt();return}v=G(),F=!0,lt();let t=await qt();F=!1,v=Array.isArray(t)?t:[],lt()}function lt(){if(y!=="music")return;let t=h("#pl-subtab-body");t&&(h("#pl-music-search")?z():t.innerHTML=ut(v||[]))}function ut(t){return zt(t)+`<div id="pl-music-results">${St(t)}</div>`}function zt(t){let e=dt(),a=Q(t).length;return`
    ...
    </div>`}function St(t){let e=Q(t);return F&&!t.length?'<div class="pl-empty-state"><p>\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</p><p class="pl-empty-hint">\u691C\u7D22\u6B04\u306F\u3053\u306E\u307E\u307E\u5165\u529B\u3067\u304D\u307E\u3059</p></div>':t.length?e.length?A==="grid"?mt(e):A==="list"?Wt(e):A==="category"?Zt(e):mt(e):F?`<div class="pl-empty-state"><p>\u6700\u65B0\u30C7\u30FC\u30BF\u3092\u78BA\u8A8D\u4E2D\u2026</p><p class="pl-empty-hint">\u300C${l(dt())}\u300D\u306E\u5019\u88DC\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059</p></div>`:'<div class="pl-empty-state"><p>\u4E00\u81F4\u3059\u308B\u52D5\u753B\u304C\u3042\u308A\u307E\u305B\u3093</p><p class="pl-empty-hint">\u300C\u66F2\u540D / \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u300D\u306E\u3088\u3046\u306B\u533A\u5207\u3063\u3066\u691C\u7D22\u3067\u304D\u307E\u3059</p></div>':'<div class="pl-empty-state"><p>\u52D5\u753B\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u307E\u305B\u3093</p><p class="pl-empty-hint">\u7BA1\u7406\u753B\u9762\u304B\u3089\u767B\u9332\u3067\u304D\u307E\u3059</p></div>'}function dt(){let t=h("#pl-music-search");return t&&(D=t.value||""),D}function it(){let t=h("#pl-subtab-body");t&&(t.innerHTML=ut(v||[]))}function Ft(){let t=q.size,e=h("#pl-music-selcount");e&&(e.textContent=`${t}\u66F2\u3092\u9078\u629E\u4E2D`);let s=document.querySelector("[data-music-select-add]");s&&(s.disabled=!t,s.innerHTML=`${w("plus")} ${t}\u66F2\u3092\u307E\u3068\u3081\u3066\u8FFD\u52A0`);let a=document.querySelector("[data-music-select-clear]");a&&(a.disabled=!t)}function z(){let t=v||[],e=h(".pl-music-count");if(e){let a=Q(t).length;e.textContent=`${a}${a===t.length?"":` / ${t.length}`}\u4EF6`}document.querySelectorAll("[data-music-view]").forEach(a=>{a.classList.toggle("active",a.dataset.musicView===A)});let s=h("#pl-music-results");s&&(s.innerHTML=St(t))}function G(){try{let t=JSON.parse(localStorage.getItem(ht)||"null");return Array.isArray(t?.videos)?t.videos:[]}catch{return[]}}function Jt(t){try{localStorage.setItem(ht,JSON.stringify({videos:t,cachedAt:Date.now()}))}catch{}}async function qt(){return H||(H=fetch("/data/music.json",{cache:"no-store"}).then(t=>t.ok?t.json():Promise.reject(new Error(`music.json ${t.status}`))).then(t=>{let e=Array.isArray(t?.videos)?t.videos:[];return Jt(e),e}).catch(()=>v||G()),H)}function kt(t){return String(t||"").normalize("NFKC").toLowerCase().replace(/[！-～]/g,e=>String.fromCharCode(e.charCodeAt(0)-65248)).replace(/[‐-‒–—―ー]/g,"-").replace(/\s+/g," ").trim()}function Ut(t){return kt(t).split(/[\/／|｜\s]+/).map(e=>e.trim()).filter(Boolean)}function Gt(t){let e=t.title||"",s=e.split(/[\/／|｜]/).map(n=>n.trim()).filter(Boolean),a=W(t).label;return kt([e,...s,t.originalArtist,t.character,t.type,a].filter(Boolean).join(" "))}function Q(t){let e=Ut(dt()),s=t.map((a,n)=>({v:a,i:n}));return e.length?s.filter(({v:a})=>{let n=Gt(a);return e.every(r=>n.includes(r))}):s}function W(t){switch(t.type){case"cover":return{label:"\u30AB\u30D0\u30FC",cls:"mv-badge-cover",sub:t.originalArtist||"\u30AB\u30D0\u30FC\u66F2"};case"office":return{label:"Re:AcT",cls:"mv-badge-office",sub:"Re:AcT"};case"character":return{label:"\u30AD\u30E3\u30E9",cls:"mv-badge-character",sub:t.character||"\u30AD\u30E3\u30E9\u30BD\u30F3"};default:return{label:"\u30AA\u30EA\u30B8\u30CA\u30EB",cls:"mv-badge-original",sub:"\u304B\u306A\u3046"}}}function J(t){return t.publishedAt?String(t.publishedAt).replaceAll("-","/"):"\u516C\u958B\u65E5\u672A\u767B\u9332"}function xt(t,e){let s=N(t.url),a=V(t.url),{label:n,cls:r}=W(t),i=U("mv:"+t.id);if(L){let c=q.has(t.id);return`
    <div class="mv-card mv-card--select${c?" is-selected":""}">
      ...
      <div class="mv-card-info">
        ...
        <span class="mv-card-sub">${l(J(t))}</span>
      </div>
    </div>`}return`
    <div class="mv-card">
      ...
      <button class="pl-sg-add mv-add-btn mv-add-btn--overlay${i?" is-saved":""}" type="button"
        ...
        title="${i?"\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u306B\u4FDD\u5B58\u6E08\u307F":"\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u306B\u8FFD\u52A0"}">${pt}</button>
      <div class="mv-card-info">
        <span class="mv-card-title">${l(t.title||"\u2014")}</span>
        <span class="mv-card-sub">${l(J(t))}</span>
      </div>
    </div>`}function Qt(t,e){let s=N(t.url),a=V(t.url),{label:n,cls:r,sub:i}=W(t),c=U("mv:"+t.id);if(L){let u=q.has(t.id);return`
    <div class="mv-list-row mv-list-row--select${u?" is-selected":""}" data-mv-select="${l(t.id)}" role="button" aria-pressed="${u}">
      ...
      <div class="mv-list-info">
        ...
        <span class="mv-list-sub">${l(J(t))}</span>
      </div>
      <span class="mv-type-badge ${r}">${n}</span>
    </div>`}return`
      ...
      <article class="song-request-item">
        ...
        <div class="song-request-tools">
          <div class="song-request-status-tabs" aria-label="\u6B4C\u5531\u30B9\u30C6\u30FC\u30BF\u30B9">
            ${ot(e.id,a,"singable","\u6B4C\u3048\u308B")}
            ${ot(e.id,a,"practicing","\u7DF4\u7FD2\u4E2D")}
            ${ot(e.id,a,"unregistered","\u672A\u767B\u9332")}
          </div>
    ...
    <div class="pl-grid">
      ...
      <div class="pl-my-actions">
        <button class="pl-new-btn" id="pl-new-btn" type="button">${w("plus")} \u65B0\u898F\u4F5C\u6210</button>
      </div>`}function me(t,e){let s=t.streams.map(u=>{let d=u.startsWith("mv:"),b=d?Z(u):null;return{skey:u,isMv:d,mv:b,stream:d?null:e.find(p=>M(p)===u)}}),a=s.find(({stream:u,mv:d})=>u?.url||d?.url)?.stream?.url||s.find(({mv:u})=>u?.url)?.mv?.url,n=a?`<img class="pl-card-cover" src="${l(N(a))}" alt="" loading="lazy" referrerpolicy="no-referrer">`:"",r=s.length,i=s.map(({skey:u,isMv:d,mv:b,stream:p})=>{let f=l(t.id+"|:|"+u),o='<span class="pl-drag-handle" aria-hidden="true" title="\u30C9\u30E9\u30C3\u30B0\u3057\u3066\u4E26\u3073\u66FF\u3048">\u283F</span>',m=`<button class="pl-rm-btn" data-pl-rm-stream="${f}" type="button" title="\u524A\u9664">${w("close")}</button>`;if(d){if(!b)return`
        ...
        </div>`;let{label:$,sub:E}=W(b),S=b.type||"original",x=(v||[]).indexOf(b);return`
      ...
      <div class="pl-stream-row" data-pl-skey="${l(u)}" data-pl-id="${l(t.id)}">
        ${o}
        <div class="pl-stream-info">
          <span class="pl-stream-date">${et(p.date)}</span>
    ...
    <div class="pl-card">
      ...
      <button class="pl-modal-item${m?" is-saved":""}" data-pl-add="${l(o.id)}"
        ...
        <span class="pl-modal-bookmark${m?" is-saved":""}" aria-hidden="true">${pt}</span>
      ...
      </div>`,i.hidden=!1,i.querySelector("#pl-modal-close").addEventListener("click",f),i.querySelector("#pl-modal-backdrop").addEventListener("click",f),i.querySelector("#pl-modal-new").addEventListener("click",()=>{let o=prompt("\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u540D")?.trim();if(!o)return;let m=wt(o);a.forEach(S=>jt(m.id,S)),ct(n?`\u300C${o}\u300D\u306B${a.length}\u66F2\u4FDD\u5B58\u3057\u307E\u3057\u305F`:`\u300C${o}\u300D\u306B\u4FDD\u5B58\u3057\u307E\u3057\u305F`);let $=i.querySelector("#pl-modal-list");$?.querySelector(".pl-modal-empty")&&($.innerHTML=""),$&&$.insertAdjacentHTML("afterbegin",u(_().find(S=>S.id===m.id))),r()}),i.querySelector("#pl-modal-list").addEventListener("click",o=>{let m=o.target.closest("[data-pl-add]");if(!m)return;let $=m.dataset.plAdd,E=_(),S=E.find(x=>x.id===$);S&&(Array.isArray(S.streams)||(S.streams=[]),c(S)?(a.forEach(x=>{S.streams=S.streams.filter(Pt=>Pt!==x)}),C(E),ct(n?`${a.length}\u66F2\u3092\u524A\u9664\u3057\u307E\u3057\u305F`:"\u524A\u9664\u3057\u307E\u3057\u305F")):(a.forEach(x=>{S.streams.includes(x)||S.streams.push(x)}),C(E),ct(n?`\u300C${S.name}\u300D\u306B${a.length}\u66F2\u4FDD\u5B58\u3057\u307E\u3057\u305F`:`\u300C${S.name}\u300D\u306B\u4FDD\u5B58\u3057\u307E\u3057\u305F`)),m.outerHTML=u(_().find(x=>x.id===$)),r())})},f=()=>{i.hidden=!0};p(),document.addEventListener("keydown",function o(m){m.key==="Escape"&&(f(),document.removeEventListener("keydown",o))})}function ct(t){let e=h("#pl-toast");e||(e=document.createElement("div"),e.id="pl-toast",document.body.appendChild(e)),e.textContent=t,e.classList.add("pl-toast--show"),clearTimeout(e._timer),e._timer=setTimeout(()=>e.classList.remove("pl-toast--show"),2500)}function gt(t,e){let s=_().find(r=>r.id===t.dataset.plId);if(!s||!window.__playMyListInViewer)return!1;let a=[];for(let r of s.streams)if(r.startsWith("mv:")){let i=Z(r);i?.url&&a.push({kind:"mv",key:r,video:i})}else{let i=e.find(c=>M(c)===r);i?.url&&a.push({kind:"stream",key:r,stream:i})}if(!a.length)return!1;let n=a.findIndex(r=>r.key===t.dataset.plSkey);return n<0&&(n=0),window.__playMyListInViewer({name:s.name||"\u30DE\u30A4\u30EA\u30B9\u30C8",items:a,idx:n}),!0}function ve(){if(y!=="my-playlists")return;let t=h("#panel-playlists");t&&t.querySelectorAll(".pl-stream-list").forEach(e=>{e.addEventListener("pointerdown",he,{passive:!1})})}var B=null;function he(t){if(B)return;let e=t.target.closest(".pl-drag-handle");if(!e)return;let s=e.closest(".pl-stream-row"),a=e.closest(".pl-stream-list");if(!s||!a)return;t.preventDefault();let n=Array.from(a.querySelectorAll(".pl-stream-row")),r=n.indexOf(s);if(r<0)return;let i=n.map(u=>{let d=u.getBoundingClientRect();return d.top+d.height/2}),c=s.getBoundingClientRect();B={list:a,row:s,rows:n,mids:i,startIdx:r,targetIdx:r,startY:t.clientY,rowH:c.height+(parseFloat(getComputedStyle(a).rowGap||getComputedStyle(a).gap)||0),plId:s.dataset.plId,moved:!1},s.classList.add("is-dragging"),a.classList.add("is-drag-active");try{s.setPointerCapture(t.pointerId)}catch{}s.addEventListener("pointermove",Lt,{passive:!1}),s.addEventListener("pointerup",It),s.addEventListener("pointercancel",Rt)}function Lt(t){let e=B;if(!e)return;t.preventDefault();let s=t.clientY-e.startY;if(!e.moved&&Math.abs(s)<3)return;e.moved=!0,e.row.style.transform=`translateY(${s}px)`;let a=e.mids[e.startIdx]+s,n=0;for(let r=0;r<e.mids.length;r++)r!==e.startIdx&&a>e.mids[r]&&n++;n!==e.targetIdx&&(e.targetIdx=n,e.rows.forEach((r,i)=>{if(i===e.startIdx)return;let c=0;e.startIdx<n&&i>e.startIdx&&i<=n?c=-e.rowH:e.startIdx>n&&i>=n&&i<e.startIdx&&(c=e.rowH),r.style.transform=c?`translateY(${c}px)`:""}))}function It(){let t=B;if(!t)return;let{plId:e,startIdx:s,targetIdx:a,moved:n}=t;if(Nt(),!n||a===s)return;let r=_(),i=r.find(c=>c.id===e);if(i&&s<i.streams.length){let c=i.streams.slice(),[u]=c.splice(s,1);c.splice(a,0,u),i.streams=c,C(r)}T()}function Rt(){Nt()}function Nt(){let t=B;t&&(t.rows.forEach(e=>{e.style.transform=""}),t.row.classList.remove("is-dragging"),t.list.classList.remove("is-drag-active"),t.row.removeEventListener("pointermove",Lt),t.row.removeEventListener("pointerup",It),t.row.removeEventListener("pointercancel",Rt),B=null)}export{_ as a,wt as b,Bt as c,jt as d,Dt as e,U as f,T as g,_e as h,Z as i,bt as j};
